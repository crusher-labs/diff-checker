...
Single-purpose static tool, built as a **world page**: galley proof. Compare two texts on a galley proof marked the way a proofreader marks it: struck-through words answered with a dele in the margin, a caret where words go in with the inserted words written beside the line, whole new lines set in red. Line diff first, word diff inside changed lines, ignore-case and ignore-space options, copy as unified diff. Nothing uploaded. Part of the crusher-labs static tools line. Hosted on GitHub Pages at https://crusher-labs.github.io/diff-checker/
